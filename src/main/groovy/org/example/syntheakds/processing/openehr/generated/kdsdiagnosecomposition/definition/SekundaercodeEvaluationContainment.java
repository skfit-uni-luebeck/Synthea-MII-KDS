...
public class SekundaercodeEvaluationContainment extends Containment {
  ...
  public SelectAqlField<KlinischerStatusCluster> KLINISCHER_STATUS = new AqlFieldImp<KlinischerStatusCluster>(SekundaercodeEvaluation.class, "/data[at0001]/items[openEHR-EHR-CLUSTER.problem_qualifier.v1]", "klinischerStatus", KlinischerStatusCluster.class, this);
