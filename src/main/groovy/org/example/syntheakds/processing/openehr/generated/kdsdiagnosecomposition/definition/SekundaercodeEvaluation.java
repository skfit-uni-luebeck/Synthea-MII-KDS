...
@Generated(
    ...
    date = "2022-11-02T11:31:18.605168100+01:00",
...
public class SekundaercodeEvaluation implements EntryEntity {
  /**
   * Path: Diagnose/Sekundärcode/Kodierte Diagnose
  ...
  /**
   * Path: Diagnose/Sekundärcode/Structure/Kodierte Diagnose/null_flavour
   */
  ...
  /**
   * Path: Diagnose/Sekundärcode/Freitextbeschreibung
  ...
  /**
   * Path: Diagnose/Sekundärcode/Structure/Freitextbeschreibung/null_flavour
   */
  ...
  /**
   * Path: Diagnose/Sekundärcode/Körperstelle
  ...
  /**
   * Path: Diagnose/Sekundärcode/Seitenlokalisation
   * Description: Identifikation einer einfachen Körperstelle zur Lokalisierung des Problems oder der Diagnose.
   * Comment: Wo dies möglich ist, ist die Kodierung der anatomischen Lokalisation über eine Terminologie zu bevorzugen. Verwenden Sie dieses Datenelement, um vorab präkoordinierte anatomische Lokalisationen zu erfassen. Wenn die Anforderungen an die Erfassung der anatomischen Lokalisation zur Laufzeit durch die Anwendung bestimmt werden oder komplexere Modellierungen, wie z.B. relative Lokalisationen erforderlich sind, dann verwenden Sie in diesem Archetyp den CLUSTER.anatomical_location oder CLUSTER.relative_location innerhalb des SLOT 'Structured anatomical location'. Die Anzahl für dieses Datenelement ist unbegrenzt, um klinische Szenarien wie die Beschreibung eines Hautausschlags an mehreren Stellen zu ermöglichen, wobei jedoch alle anderen Attribute identisch sind. Falls die anatomische Lage über präkoordinierte Codes im Namen des Problems/Diagnose enthalten ist, wird dieses Datenelement überflüssig.
   */
  ...
  /**
   * Path: Diagnose/Sekundärcode/Anatomische Stelle (strukturiert)
  ...
  /**
   * Path: Diagnose/Sekundärcode/Klinisch relevanter Zeitraum (Zeitpunkt des Auftretens)
  ...
  /**
   * Path: Diagnose/Sekundärcode/Structure/Klinisch relevanter Zeitraum (Zeitpunkt des Auftretens)/null_flavour
   */
  ...
  /**
   * Path: Diagnose/Sekundärcode/Feststellungsdatum
  ...
  /**
   * Path: Diagnose/Sekundärcode/Structure/Feststellungsdatum/null_flavour
   */
  ...
  /**
   * Path: Diagnose/Sekundärcode/Mehrfachkodierungskennzeichen_ICD-10-GM
  ...
  /**
   * Path: Diagnose/Sekundärcode/Klinisch relevanter Zeitraum (Zeitpunkt der Genesung)
  ...
  /**
   * Path: Diagnose/Sekundärcode/Structure/Klinisch relevanter Zeitraum (Zeitpunkt der Genesung)/null_flavour
   */
  ...
  /**
   * Path: Diagnose/Sekundärcode/Klinischer Status
   * Description: Kontextabhängiges oder temporäres Attribut für ein bestimmtes Problem oder eine bestimmte Diagnose.
   */
  @Path("/data[at0001]/items[openEHR-EHR-CLUSTER.problem_qualifier.v1 and name/value='Klinischer Status']")
  private KlinischerStatusCluster klinischerStatus;

  /**
   * Path: Diagnose/Sekundärcode/Diagnosesicherheit
  ...
  /**
   * Path: Diagnose/Sekundärcode/Diagnoseerläuterung
  ...
  /**
   * Path: Diagnose/Sekundärcode/Structure/Diagnoseerluterung/null_flavour
   */
  ...
  /**
   * Path: Diagnose/Sekundärcode/Letztes Dokumentationsdatum
  ...
  /**
   * Path: Diagnose/Sekundärcode/Tree/Letztes Dokumentationsdatum/null_flavour
   */
  ...
  /**
   * Path: Diagnose/Sekundärcode/Erweiterung
  ...
  /**
   * Path: Diagnose/Sekundärcode/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: Diagnose/Sekundärcode/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: Diagnose/Sekundärcode/feeder_audit
   */
  @Path("/feeder_audit")
