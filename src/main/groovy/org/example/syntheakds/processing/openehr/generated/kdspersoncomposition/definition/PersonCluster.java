...
@Generated(
    ...
    date = "2022-11-02T11:32:17.945102+01:00",
...
public class PersonCluster implements LocatableEntity {
   ...
   */
  @Path("/items[openEHR-EHR-CLUSTER.structured_name.v0 and name/value='Name']")
   ...
   * Description: Details zu den einzelnen Komponenten des Namens einer Person zur Verwendung in einer Gesundheitsakte.
   */
  @Path("/items[openEHR-EHR-CLUSTER.structured_name.v0 and name/value='Geburtsname']")
