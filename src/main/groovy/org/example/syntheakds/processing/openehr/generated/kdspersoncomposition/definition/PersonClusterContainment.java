...
public class PersonClusterContainment extends Containment {
  ...
  public SelectAqlField<NameCluster> NAME = new AqlFieldImp<NameCluster>(PersonCluster.class, "/items[openEHR-EHR-CLUSTER.structured_name.v0]", "name", NameCluster.class, this);

  public SelectAqlField<GeburtsnameCluster> GEBURTSNAME = new AqlFieldImp<GeburtsnameCluster>(PersonCluster.class, "/items[openEHR-EHR-CLUSTER.structured_name.v0]", "geburtsname", GeburtsnameCluster.class, this);
